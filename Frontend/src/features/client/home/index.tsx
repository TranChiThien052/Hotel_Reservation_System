    ...
    <div>
      ...
      <div className="bg-gray-50 mt-20 pt-10 pb-10">
        <div>
          <div className="flex justify-between items-center px-10 mb-10">
            ...
            <div className="border-3 rounded-2xl border-orange-400 p-2 text-orange-500 cursor-pointer hover:bg-orange-400 hover:text-white transition-colors duration-300" onClick={handleViewAllRooms}>
              Xem tất cả phòng
            </div>
          </div>
      ...
      <div className="w-full px-15 ">
        ...
        <div className="flex flex-col items-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center ">
          ...
          <div onClick={handleViewAllRooms} className="bg-orange-400 hover:bg-orange-500 text-white px-6 py-4 rounded-lg text-lg w-1/2 flex items-center justify-center gap-2 font-medium cursor-pointer mt-8">
            <FaSearch />
            Khám phá phòng nghỉ
          </div>
        </div>
