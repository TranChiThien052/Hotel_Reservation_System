...
import type { Account, AccountFormData } from "@/features/admin/adminAccounts/types/accounts-type";
import { USER_ROLE } from "@/features/admin/adminAccounts/types/user-role-type";
import { useFormModal } from "@/shared/hooks/useFormModal";
import { FormModalModes } from "@/shared/types/type-form-mode";
import { Button, Dropdown, Input, Select, Space, Table, Tag, type MenuProps, type TableProps } from "antd";
...
import { staffAccountsFormFields } from "../constants/staffAccounts-form-field";
...
const StaffAcccount = () => {
  ...
  const fetchAccounts = useCallback(async () => {
    setLoading(true);
    try {
      const data = await accountApi.getStaffAccountsByBranchId(user?.branch_id || "");
  ...
  return (
    <div className="p-7 flex flex-col gap-5 ">
      <div className="flex items-center justify-between mt-3">
        ...
        >
          <CiCirclePlus /> Thêm tài khoản nhân viên mới
        </div>
      </div>
      ...
      <FormModal
        ...
        fields={staffAccountsFormFields}
