...
import { managerServicesFormFields } from "../constants/managerServices-form-fields";
...
const ManagerService = () => {
  ...
  const fetchServices = useCallback(async () => {
    ...
    try {
      const data = await servicesApi.getServicesByBranchId(branchId);
  ...
  return (
    <div className="p-7 flex flex-col gap-5 ">
      ...
      <FormModal
        ...
        fields={managerServicesFormFields}
