...
import { managerDiscountFormFields } from "../contants/managerDiscount-form-fields";
...
const ManagerDiscounts = () => {
  ...
  const fetchPromotions = useCallback(async () => {
    ...
    try {
      const data = await promotionApi.getByBranchId(user?.branch_id);
  ...
  return (
    <div className="p-7 flex flex-col gap-5 ">
      ...
      <FormModal
        ...
        fields={managerDiscountFormFields}
