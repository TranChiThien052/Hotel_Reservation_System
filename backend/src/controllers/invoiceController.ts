...
class InvoiceController {
    ...
    async createInvoice(req, res) {
        const { invoice_code, booking_id, room_charge, service_charge, fine_charge, late_checkout_fee, early_checkout_fee, discount_amount, total_amount, deposit_used, amount_due, refund_amount, issued_by, notes } = req.body;
        const data = { invoice_code, booking_id, room_charge, service_charge, fine_charge, late_checkout_fee, early_checkout_fee, discount_amount, total_amount, deposit_used, amount_due, refund_amount, issued_by, notes };
